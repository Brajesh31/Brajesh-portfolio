...
export const disableDevTools = () => {
  ...
  watermark.innerHTML = '© 2024 Brajesh Kumar - All Rights Reserved';
...
export const consoleWarning = () => {
  ...
  console.log('%c© 2024 Brajesh Kumar - All Rights Reserved', 'color: orange; font-size: 16px; font-weight: bold;');
  console.log('%cFor licensing inquiries: bk117134@gmail.com', 'color: orange; font-size: 12px;');
};
