...
const PLANETS = [
  { id: "about",      label: "About",          distance: 4,    speed: 0.011, color: "#f5c36b" },
  { id: "experience", label: "Experience",     distance: 5.5,  speed: 0.010, color: "#8a2be2" },
  { id: "ai-skills",  label: "AI Skills",      distance: 7,    speed: 0.009, color: "#4169e1" },
  { id: "web-skills", label: "Web Dev",        distance: 8.5,  speed: 0.008, color: "#228b22" },
  { id: "blog",       label: "Blog",           distance: 10,   speed: 0.007, color: "#ffa500" },
  { id: "projects",   label: "Projects",       distance: 11.5, speed: 0.006, color: "#20b2aa" },
  { id: "services",   label: "Services",       distance: 13,   speed: 0.005, color: "#2f4f4f" },
  { id: "community",  label: "Community",      distance: 14.5, speed: 0.004, color: "#ff6347" },
  { id: "events",     label: "Talks & Events", distance: 16,   speed: 0.003, color: "#dc143c" },
  { id: "contact",    label: "Contact",        distance: 17.5, speed: 0.002, color: "#9932cc" },
];
