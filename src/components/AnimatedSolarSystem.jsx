...
const PLANETS = [
  ...
  { id: 'notebooks', label: 'Notebooks', color: '#9b59b6', orbit: 240, duration: 40 },
  { id: 'opensource', label: 'Open Source', color: '#f39c12', orbit: 270, duration: 45 },
  { id: 'community', label: 'Community', color: '#1abc9c', orbit: 300, duration: 50 },
  { id: 'blog', label: 'Talks & Events', color: '#e67e22', orbit: 330, duration: 55 },
          ...
          {PLANETS.map((planet, i) => (
              ...
              >
                ...
                <div className="absolute right-0 top-1/2 -translate-y-1/2 pointer-events-auto">
                  <button
                      onClick={() => {
                        // Redirect "Talks & Events" to blog page
                        if (planet.id === 'blog') {
                          onPlanetClick('blog');
                        } else {
