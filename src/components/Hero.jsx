...
export default function Hero() {
  ...
  return (
              ...
              >
                <div className="relative group">
                  <p className="text-xl text-gray-700 dark:text-gray-100 max-w-2xl leading-relaxed">
                    Engineering neural networks to deliver
                    <span
    ...
    {" "}intelligent solutions{" "}
                    ...
                    that seamlessly merge human imagination with the power of artificial intelligence.
                  </p>
              ...
              >
                <div className="relative group">
                  ...
                  <img
                      ...
                      style={{
                        filter:
                            "contrast(1.05) brightness(0.95) drop-shadow(0 0 20px rgba(245, 195, 107, 0.6)) drop-shadow(0 0 40px rgba(245, 195, 107, 0.3))",
        ...
        <div className="max-w-6xl mx-auto relative z-10 py-16">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            {/* GitHub Activity */}
            <div className="bg-white/80 dark:bg-black/20 border border-amber-400/40 dark:border-amber-400/20 rounded-2xl p-8 backdrop-blur-sm">
              <LiveGitHubActivity username="brajesh31" />
            </div>
          </div>
        </div>
