...
const SECTIONS = [
  {
    id: 'about',
    title: 'About Me',
    description: "I'm Brajesh Kumar, a 3rd year Computer Science Engineering student at GL Bajaj. Passionate about competitive coding, full-stack web and AI/ML development, and real-world software solutions. Always curious and building new things.",
    skills: ['C', 'C++', 'Python', 'JavaScript', 'React', 'AI/ML'],
    color: '#f5c36b'
  },
  {
    id: 'ongoing',
    title: 'Current Studies',
    description: 'Focused on advanced data structures, algorithms, and machine learning. Building practical web and AI projects, participating in hackathons, and currently exploring NLP research and top online courses.',
    skills: ['DSA', 'Web Dev', 'ML', 'Hackathons'],
    color: '#4a90e2'
  },
  {
    id: 'ai-skills',
    title: 'AI & ML Skills',
    description: 'Practical experience with Python, scikit-learn, pandas, and NumPy for predictive modeling, data analysis, and small AI projects like chatbots. Focused on hands-on applications and competitions.',
  ...
  },
  {
    ...
    description: 'Fluent in React, Node.js, SQL, and Git. Built dynamic web apps, REST APIs, and integrated data visualizations for campus and personal projects.',
  ...
  },
  {
    ...
    description: 'Led development for a sentiment analysis tool using Python and NLP, analyzing real social data and generating actionable visualizations.',
  ...
  },
  {
    ...
    description: 'Performed data wrangling and advanced visualization of large datasets using pandas, matplotlib, and seaborn—translating data to insights.',
  ...
  },
  {
    ...
    description: 'Built and compared several supervised ML models on real-world data, optimizing for accuracy and real deployment in coursework.',
  ...
  },
  {
    ...
    description: 'Completed a range of mini-projects: code automation scripts, CP problems, React widgets, and ML experiments for hands-on growth.',
  ...
  },
  {
    id: 'services',
    title: 'Future Goals',
    description: 'Aiming for a career as an AI/ML engineer or developer—solving real challenges, learning new technologies, and contributing to impactful projects and communities.',
  ...
  },
  {
    ...
    description: "Open for internships, collaborations, hackathons, and networking. Let's connect, build, and learn together in tech!",
    skills: ['Networking', 'Opportunities', 'Collaboration'],
    color: '#c0392b',
    socials: [
      { name: 'GitHub', url: 'https://github.com/brajesh31', icon: 'github' },
      { name: 'LinkedIn', url: 'https://in.linkedin.com/in/brajesh-kumar-9b58651a8', icon: 'linkedin' },
      { name: 'Instagram', url: 'https://instagram.com/lord_brajesh', icon: 'instagram' }
    ]
  },
];
