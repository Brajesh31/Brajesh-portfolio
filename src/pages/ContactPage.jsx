          ...
          <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-amber-300">bk117134@gmail.com</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 rounded-full bg-gradient-to-br from-amber-500 to-amber-600 flex items-center justify-center">
                    ...
                    <div>
                      ...
                      <p className="text-amber-300">linkedin.com/in/brajesh-kumar-9b58651a8</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 rounded-full bg-gradient-to-br from-amber-500 to-amber-600 flex items-center justify-center">
                    ...
                    <div>
                      ...
                      <p className="text-amber-300">@brajesh31</p>
                    </div>
                  </div>
                </div>
              </TiltCard>
            ...
            <TextReveal delay={400}>
              <TiltCard className="bg-white/5 backdrop-blur-sm border border-amber-400/20 rounded-2xl p-8">
                ...
                <form className="space-y-4" action="https://formspree.io/f/mrblvkdp" method="POST" target="_blank">
                  <div>
